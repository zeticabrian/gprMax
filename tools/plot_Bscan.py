...
def mpl_plot(filename, outputdata, dt, rxnumber, rxcomponent,cmap,ampmin,ampmax):
    ...
    plt.imshow(outputdata, extent=[0, outputdata.shape[1], outputdata.shape[0] * dt, 0], interpolation='nearest', aspect='auto', cmap=cmap, vmin=ampmin, vmax=ampmax)
